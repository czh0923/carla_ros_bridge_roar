...
class CarlaRosBridge(CompatibleNode):
    ...
    def initialize_bridge(self, carla_world, params):
        ...
        temp_carla_client = carla.Client("localhost", 2000)
        print("444444444444444")
        temp_carla_world = temp_carla_client.get_world()
        #print("why")
        print("5555555555555")
        temp_carla_setting = temp_carla_world.get_settings()
...
def main(args=None):
    ...
    #parameters['host'] = '128.32.43.216'

    print("hereeeeeee", parameters['host'])
    ...
    try:
        ...
        print("create client", parameters['host'])
        ...
        print("before getting world")

        carla_world = carla_client.get_world()

        print("get world done")

        # comment town if connecting to 337D
